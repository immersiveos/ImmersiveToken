...
contract('ImmersiveToken', function(accounts) {
  ...
  it('Should allow funder to transfer tokens to another account', () => {
    // todo: tokens should be transferable by funder during or after the campagin failed or succeeded
  })
})
